        ...
        <React.Fragment>
            ...
            <Box sx={{
                ...
                {/* <PageHeading1 /> */}
                    ...
                    <Typography variant="h5" align="center" color="text.secondary" component="p" sx={{ width: '70%', margin: 'auto', fontSize: "1.158vw" }}>
                ...
                <Box sx={{ padding: "24px", maxWidth: "1317px", margin: "auto", padding: '0' }}>
                    <Grid container spacing={0} alignItems="flex-end">
                        {tiers.map((tier) => (
                            ...
                            >
                                <Card sx={{
                                    position: tier.title !== 'Most popular' ? 'relative' : 'static',
                                    top: tier.title !== 'Most popular' ? '-120px' : '0px',
                                    ...
                                    <CardHeader
                                        ...
                                        titleTypographyProps={{ align: 'center', fontWeight: '700', color: 'white', fontSize: "1.2vw" }}
                                    ...
                                    <CardContent sx={{
                                        ...
                                        <Box
                                            sx={{
                                                ...
                                                mb: 2,
                                                padding: '2rem 40px',
                                                height: tier.title === 'Most popular' ? '16rem' : '11.5rem'
                                            }}
                                        >
                                            <Stack>
                                                <Typography component="h2" variant="h3" sx={{ fontWeight: '700', fontSize: tier.title === 'Most popular' ? '2.78vw' : '1.86vw', textAlign:"center" }} color="text.primary">
                                                    {tier.priceTitle}
                                                </Typography>
                                                <Typography component="h2" variant="h3" sx={{ fontSize: tier.title === 'Most popular' ? '4.65vw' : '2.78vw' , fontWeight: '700' }} color="text.primary">
                                                    ${tier.price+" "}
                                                    <Typography variant="span" sx={{ fontSize: '1.5rem', fontWeight: '400' }} color="text.secondary">
                                                        /month
                                                    </Typography>
                                                </Typography>
                                            </Stack>
                                        ...
                                        <Box
                                            sx={{
                                                ...
                                                padding: '1rem 2rem',
                                                background: '#F5F5F5',
                                                height: tier.title === 'Most popular' ? '24.563rem' : '18.375rem'
                                            }}
                                        >
                                                ...
                                                {tier.description.map((line) => (
                                                    ...
                                                    <Stack sx={{ flexDirection: 'row' }}>
                                                        ...
                                                        <Typography
                                                            ...
                                                            align="center"
                                                            key={line}
                                                            sx={{ lineHeight: '2.75', textAlign: 'left', marginLeft: '1rem' }}
                                                        >
